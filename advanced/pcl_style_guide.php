...
include name: <code class="docutils literal notranslate"><span class="pre">pcl/filters/bilateral.h</span></code> becomes <code class="docutils literal notranslate"><span class="pre">PCL_FILTERS_BILATERAL_H_</span></code>.
The <code class="docutils literal notranslate"><span class="pre">#ifndef</span></code> and <code class="docutils literal notranslate"><span class="pre">#define</span></code> lines should be placed just past the BSD license.
The <code class="docutils literal notranslate"><span class="pre">#endif</span></code> goes all the way at the bottom and needs to have the define name in
its comment, e.g:</p>
<blockquote>
