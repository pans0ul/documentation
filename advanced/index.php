...
<ul>
<li><p class="first"><a class="reference internal" href="c_cache.php#c-cache"><span class="std std-ref">Using CCache to speed up compilation</span></a></p>
...
<li><p class="first"><a class="reference internal" href="distcc.php#distc"><span class="std std-ref">Using DistCC to speed up compilation</span></a></p>
...
<li><p class="first"><a class="reference internal" href="compiler_optimizations.php#compiler-optimizations"><span class="std std-ref">Compiler optimizations</span></a></p>
...
<li><p class="first"><a class="reference internal" href="single_compile_unit.php#single-compile-unit"><span class="std std-ref">Single compilation units</span></a></p>
...
guidelines_</strong> as you see in the <a class="reference internal" href="pcl_style_guide.php#pcl-style-guide"><span class="std std-ref">PCL C++ Programming Style Guide</span></a>.</li>
</ul>
</div>
<ul>
<li><p class="first"><a class="reference internal" href="pcl_style_guide.php#pcl-style-guide"><span class="std std-ref">PCL C++ Programming Style Guide</span></a></p>
<p>Please follow the following naming and indentation rules when developing code for PCL.</p>
</li>
<li><p class="first"><a class="reference internal" href="exceptions_guide.php#exceptions-guide"><span class="std std-ref">Exceptions in PCL</span></a></p>
<p>Short documentation on how to add new, throw and handle exceptions in PCL.</p>
</li>
<li><p class="first"><a class="reference internal" href="pcl2.php#pcl2"><span class="std std-ref">PCL 2.x API consideration guide</span></a></p>
...
<ul>
<li><p class="first"><a class="reference internal" href="how_to_write_a_tutorial.php#how-to-write-a-tutorial"><span class="std std-ref">How to write a good tutorial</span></a></p>
...
<ul>
<li><p class="first"><a class="reference internal" href="minimal_example.php#minimal-example"><span class="std std-ref">How to build a minimal example</span></a></p>
