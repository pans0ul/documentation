...
<ul class="simple">
<li><strong>PCL_SHARED_LIBS</strong> is checked by default. Uncheck it if you want static PCL libs (not recommended).</li>
...
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">It is highly recommended to add the bin folder in PCL installation tree (e.g. C:\Program Files\PCL\bin)
