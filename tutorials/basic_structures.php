...
<blockquote>
<div><ul>
<li><p class="first"><a href="#id3"><span class="problematic" id="id4">:pcl:`width&lt;pcl::PointCloud::width&gt;`</span></a> (int)</p>
...
<li><p class="first"><a href="#id5"><span class="problematic" id="id6">:pcl:`height&lt;pcl::PointCloud::height&gt;`</span></a> (int)</p>
...
<li><p class="first"><a href="#id7"><span class="problematic" id="id8">:pcl:`points&lt;pcl::PointCloud::points&gt;`</span></a> (std::vector&lt;PointT&gt;)</p>
...
<li><p class="first"><a href="#id9"><span class="problematic" id="id10">:pcl:`is_dense&lt;pcl::PointCloud::is_dense&gt;`</span></a> (bool)</p>
...
<li><p class="first"><a href="#id11"><span class="problematic" id="id12">:pcl:`sensor_origin_&lt;pcl::PointCloud::sensor_origin_&gt;`</span></a> (Eigen::Vector4f)</p>
...
<li><p class="first"><a href="#id13"><span class="problematic" id="id14">:pcl:`sensor_orientation_&lt;pcl::PointCloud::sensor_orientation_&gt;`</span></a> (Eigen::Quaternionf)</p>
