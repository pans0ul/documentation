...
<ul class="simple">
<li><a class="reference internal" href="#create-a-pcl-visualizer-in-qt-to-colorize-clouds" id="id1">Create a PCL visualizer in Qt to colorize clouds</a><ul>
<li><a class="reference internal" href="#the-project" id="id2">The project</a></li>
<li><a class="reference internal" href="#user-interface-ui" id="id3">User interface (UI)</a></li>
<li><a class="reference internal" href="#the-code" id="id4">The code</a><ul>
<li><a class="reference internal" href="#pclviewer-h" id="id5">pclviewer.h</a></li>
<li><a class="reference internal" href="#pclviewer-cpp" id="id6">pclviewer.cpp</a></li>
</ul>
</li>
<li><a class="reference internal" href="#compiling-and-running" id="id7">Compiling and running</a></li>
</ul>
</li>
</ul>
</div>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="k">protected</span><span class="o">:</span>
    ...
    <span class="n">boost</span><span class="o">::</span><span class="n">shared_ptr</span><span class="o">&lt;</span><span class="n">pcl</span><span class="o">::</span><span class="n">visualization</span><span class="o">::</span><span class="n">PCLVisualizer</span><span class="o">&gt;</span> <span class="n">viewer_</span><span class="p">;</span>
...
<dl class="docutils">
<dt>These are the protected members of our class;</dt>
<dd><ul class="first last simple">
<li><code class="docutils literal notranslate"><span class="pre">viewer_</span></code> is the visualizer object</li>
<li><code class="docutils literal notranslate"><span class="pre">cloud_</span></code> holds the point cloud displayed</li>
<li><code class="docutils literal notranslate"><span class="pre">filtering_axis_</span></code> stores on which axis we want to filter the point cloud. We need this variable because we only have one slot for 3 axes.</li>
<li><code class="docutils literal notranslate"><span class="pre">color_mode_</span></code> stores the color mode for the colorization, we need this variable for the same reason we need <code class="docutils literal notranslate"><span class="pre">filtering_axis_</span></code></li>
<li><code class="docutils literal notranslate"><span class="pre">colorCloudDistances</span> <span class="pre">()</span></code> is the member function that actually colorize the point cloud.</li>
</ul>
</dd>
</dl>
</div>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="p">{</span>
  ...
  <span class="k">for</span> <span class="p">(</span><span class="kt">size_t</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">cloud_</span><span class="o">-&gt;</span><span class="n">points</span><span class="p">.</span><span class="n">size</span> <span class="p">();</span> <span class="o">++</span><span class="n">i</span><span class="p">)</span>
  <span class="p">{</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="k">for</span> <span class="p">(</span><span class="n">PointCloudT</span><span class="o">::</span><span class="n">iterator</span> <span class="n">cloud_it</span> <span class="o">=</span> <span class="n">cloud_</span><span class="o">-&gt;</span><span class="n">begin</span> <span class="p">();</span> <span class="n">cloud_it</span> <span class="o">!=</span> <span class="n">cloud_</span><span class="o">-&gt;</span><span class="n">end</span> <span class="p">();</span> <span class="o">++</span><span class="n">cloud_it</span><span class="p">)</span>
  <span class="p">{</span>
    ...
    <span class="p">{</span>
      <span class="k">case</span> <span class="mi">0</span><span class="o">:</span>  <span class="c1">// x</span>
        <span class="n">value</span> <span class="o">=</span> <span class="n">boost</span><span class="o">::</span><span class="n">math</span><span class="o">::</span><span class="n">iround</span> <span class="p">(</span> <span class="p">(</span><span class="n">cloud_it</span><span class="o">-&gt;</span><span class="n">x</span> <span class="o">-</span> <span class="n">min</span><span class="p">)</span> <span class="o">*</span> <span class="n">lut_scale</span><span class="p">);</span>  <span class="c1">// Round the number to the closest integer</span>
        <span class="k">break</span><span class="p">;</span>
      <span class="k">case</span> <span class="mi">1</span><span class="o">:</span>  <span class="c1">// y</span>
        <span class="n">value</span> <span class="o">=</span> <span class="n">boost</span><span class="o">::</span><span class="n">math</span><span class="o">::</span><span class="n">iround</span> <span class="p">(</span> <span class="p">(</span><span class="n">cloud_it</span><span class="o">-&gt;</span><span class="n">y</span> <span class="o">-</span> <span class="n">min</span><span class="p">)</span> <span class="o">*</span> <span class="n">lut_scale</span><span class="p">);</span>
        <span class="k">break</span><span class="p">;</span>
      <span class="k">default</span><span class="o">:</span>  <span class="c1">// z</span>
        <span class="n">value</span> <span class="o">=</span> <span class="n">boost</span><span class="o">::</span><span class="n">math</span><span class="o">::</span><span class="n">iround</span> <span class="p">(</span> <span class="p">(</span><span class="n">cloud_it</span><span class="o">-&gt;</span><span class="n">z</span> <span class="o">-</span> <span class="n">min</span><span class="p">)</span> <span class="o">*</span> <span class="n">lut_scale</span><span class="p">);</span>
        <span class="k">break</span><span class="p">;</span>
    <span class="p">}</span>
</pre></div>
</div>
...
<dd><ul class="first last simple">
<li>You have configured the Qt project (see <a class="reference external" href="http://www.pointclouds.org/documentation/tutorials/qt_visualizer.php#qt-configuration">Qt visualizer tutorial</a>) and you can compile/run just by clicking on the bottom left “Play” button.</li>
