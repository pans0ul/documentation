...
<p class="last">This grabber obsoletes <cite>PXCGrabber</cite>, which was a Windows-only solution
...
<ul class="simple">
<li><a class="reference internal" href="#grabbing-point-clouds-from-depthsense-cameras" id="id2">Grabbing point clouds from DepthSense cameras</a></li>
<li><a class="reference internal" href="#depthsense-sdk-installation" id="id3">DepthSense SDK installation</a><ul>
<li><a class="reference internal" href="#linux" id="id4">Linux</a></li>
<li><a class="reference internal" href="#windows" id="id5">Windows</a></li>
</ul>
</li>
<li><a class="reference internal" href="#pcl-configuration" id="id6">PCL configuration</a></li>
<li><a class="reference internal" href="#depthsense-viewer" id="id7">DepthSense Viewer</a></li>
</ul>
</div>
</div>
