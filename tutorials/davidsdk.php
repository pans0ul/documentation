...
<ul class="simple">
<li><a class="reference internal" href="#grabbing-point-clouds-meshes-from-davidsdk-scanners" id="id15">Grabbing point clouds / meshes from davidSDK scanners</a><ul>
<li><a class="reference internal" href="#install-davidsdk" id="id16">Install davidSDK</a></li>
<li><a class="reference internal" href="#configuring-pcl" id="id17">Configuring PCL</a></li>
<li><a class="reference internal" href="#platform-specific-directives" id="id18">Platform specific directives</a></li>
<li><a class="reference internal" href="#file-formats" id="id19">File formats</a></li>
<li><a class="reference internal" href="#calibration" id="id20">Calibration</a></li>
<li><a class="reference internal" href="#using-the-example" id="id21">Using the example</a></li>
</ul>
</li>
</ul>
</div>
...
<li><a class="reference external" href="https://github.com/InstitutMaupertuis/davidSDK">Victor Lamoine davidSDK fork</a></li>
</ul>
</div></blockquote>
<p>Please test <a class="reference external" href="https://github.com/InstitutMaupertuis/davidSDK/blob/master/README.md#example-project-using-the-davidsdk">the example project</a> before going further.</p>
