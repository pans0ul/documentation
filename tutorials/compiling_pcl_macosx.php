...
<dd>Apple’s powerful integrated development environment</dd>
</dl>
</li>
<li><dl class="first docutils">
<dt><strong>MacPorts</strong> (<a class="reference external" href="http://www.macports.org">http://www.macports.org</a>)</dt>
<dd>An open-source community initiative to design an easy-to-use
system for compiling, installing, and upgrading  either command-line, X11 or
Aqua based open-source software on the Mac OS X operating system.</dd>
</dl>
</li>
</ul>
</div>
...
<dd>computes the convex hull, Delaunay triangulation, Voronoi diagram, halfspace
...
<dd>Google’s framework for writing C++ tests on a variety of platforms. Used
to build test units.</dd>
</dl>
</li>
<li><dl class="first docutils">
<dt><strong>Doxygen</strong> (<a class="reference external" href="http://www.doxygen.org">http://www.doxygen.org</a>)</dt>
<dd>A documentation system for C++, C, Java, Objective-C, Python, IDL (Corba and
Microsoft flavors), Fortran, VHDL, PHP, C#, and to some extent D.</dd>
</dl>
</li>
<li><dl class="first docutils">
<dt><strong>Sphinx</strong> (<a class="reference external" href="http://sphinx-doc.org/">http://sphinx-doc.org/</a>)</dt>
<dd>A tool that makes it easy to create intelligent and beautiful
documentation.</dd>
</dl>
</li>
</ul>
