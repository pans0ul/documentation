...
<blockquote>
<div><ul class="simple">
<li><a class="reference internal" href="#basic-usage"><span class="std std-ref">Basic Usage</span></a></li>
<li><a class="reference internal" href="#advanced-usage"><span class="std std-ref">Advanced Usage</span></a></li>
<li><a class="reference internal" href="#applications-tutorial"><span class="std std-ref">Applications</span></a></li>
<li><a class="reference internal" href="#features-tutorial"><span class="std std-ref">Features</span></a></li>
<li><a class="reference internal" href="#filtering-tutorial"><span class="std std-ref">Filtering</span></a></li>
<li><a class="reference internal" href="#i-o"><span class="std std-ref">I/O</span></a></li>
<li><a class="reference internal" href="#keypoints-tutorial"><span class="std std-ref">Keypoints</span></a></li>
<li><a class="reference internal" href="#kdtree-tutorial"><span class="std std-ref">KdTree</span></a></li>
<li><a class="reference internal" href="#octree-tutorial"><span class="std std-ref">Octree</span></a></li>
<li><a class="reference internal" href="#range-images"><span class="std std-ref">Range Images</span></a></li>
<li><a class="reference internal" href="#recognition-tutorial"><span class="std std-ref">Recognition</span></a></li>
<li><a class="reference internal" href="#registration-tutorial"><span class="std std-ref">Registration</span></a></li>
<li><a class="reference internal" href="#sample-consensus"><span class="std std-ref">Sample Consensus</span></a></li>
<li><a class="reference internal" href="#segmentation-tutorial"><span class="std std-ref">Segmentation</span></a></li>
<li><a class="reference internal" href="#surface-tutorial"><span class="std std-ref">Surface</span></a></li>
<li><a class="reference internal" href="#visualization-tutorial"><span class="std std-ref">Visualization</span></a></li>
<li><a class="reference internal" href="#gpu"><span class="std std-ref">GPU</span></a></li>
</ul>
</div></blockquote>
</div>
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="walkthrough.php#walkthrough"><span class="std std-ref">PCL Walkthrough</span></a></p>
<blockquote>
...
<li><p class="first"><a class="reference internal" href="basic_structures.php#basic-structures"><span class="std std-ref">Getting Started / Basic Structures</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="using_pcl_pcl_config.php#using-pcl-pcl-config"><span class="std std-ref">Using PCL in your own project</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<li><p class="first"><a class="reference internal" href="compiling_pcl_posix.php#compiling-pcl-posix"><span class="std std-ref">Compiling PCL from source on POSIX compliant systems</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/pcl_logo.png"><img alt="mi_11" src="_images/pcl_logo.png" style="height: 75px;" /></a></td>
<td><p class="first">Title: <strong>Compiling PCL from source on POSIX compliant systems</strong></p>
<p>Author: <em>Victor Lamoine</em></p>
<p>Compatibility: &gt; PCL 1.0</p>
<p class="last">In this tutorial, we will explain how to compile PCL from sources on POSIX/Unix systems.</p>
</td>
</tr>
</tbody>
</table>
...
<li><p class="first"><a class="reference internal" href="building_pcl.php#building-pcl"><span class="std std-ref">Customizing the PCL build process</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="compiling_pcl_dependencies_windows.php#compiling-pcl-dependencies-windows"><span class="std std-ref">Building PCL’s dependencies from source on Windows</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="compiling_pcl_windows.php#compiling-pcl-windows"><span class="std std-ref">Compiling PCL from source on Windows</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="8%" />
...
<li><p class="first"><a class="reference internal" href="compiling_pcl_macosx.php#compiling-pcl-macosx"><span class="std std-ref">Compiling PCL and its dependencies from MacPorts and source on Mac OS X</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="installing_homebrew.php#installing-homebrew"><span class="std std-ref">Installing on Mac OS X using Homebrew</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="using_pcl_with_eclipse.php#using-pcl-with-eclipse"><span class="std std-ref">Using PCL with Eclipse</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="8%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/eclipse.png"><img alt="mi_8" src="_images/eclipse.png" style="height: 100px;" /></a></td>
...
<li><p class="first"><a class="reference internal" href="generate_local_doc.php#generate-local-doc"><span class="std std-ref">Generate a local documentation for PCL</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="8%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/pcl_logo.png"><img alt="mi_11" src="_images/pcl_logo.png" style="height: 75px;" /></a></td>
<td><p class="first">Title: <strong>Generate a local documentation for PCL</strong></p>
<p>Author: <em>Victor Lamoine</em></p>
<p>Compatibility: PCL &gt; 1.0</p>
<p class="last">This tutorial shows you how to generate and use a local documentation for PCL.</p>
</td>
</tr>
</tbody>
</table>
...
<li><p class="first"><a class="reference internal" href="matrix_transform.php#matrix-transform"><span class="std std-ref">Using a matrix to transform a point cloud</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="9%" />
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="adding_custom_ptype.php#adding-custom-ptype"><span class="std std-ref">Adding your own custom PointT type</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="writing_new_classes.php#writing-new-classes"><span class="std std-ref">Writing a new PCL class</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="how_features_work.php#how-3d-features-work"><span class="std std-ref">How 3D Features work in PCL</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="normal_estimation.php#normal-estimation"><span class="std std-ref">Estimating Surface Normals in a PointCloud</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="normal_estimation_using_integral_images.php#normal-estimation-using-integral-images"><span class="std std-ref">Normal Estimation Using Integral Images</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="pfh_estimation.php#pfh-estimation"><span class="std std-ref">Point Feature Histograms (PFH) descriptors</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="fpfh_estimation.php#fpfh-estimation"><span class="std std-ref">Fast Point Feature Histograms (FPFH) descriptors</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="vfh_estimation.php#vfh-estimation"><span class="std std-ref">Estimating VFH signatures for a set of points</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="3%" />
...
<li><p class="first"><a class="reference internal" href="narf_feature_extraction.php#narf-feature-extraction"><span class="std std-ref">How to extract NARF Features from a range image</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<li><p class="first"><a class="reference internal" href="moment_of_inertia.php#moment-of-inertia"><span class="std std-ref">Moment of inertia and eccentricity based descriptors</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="rops_feature.php#rops-feature"><span class="std std-ref">RoPs (Rotational Projection Statistics) feature</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="9%" />
...
<li><p class="first"><a class="reference internal" href="gasd_estimation.php#gasd-estimation"><span class="std std-ref">Globally Aligned Spatial Distribution (GASD) descriptors</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/gasd_estimation.png"><img alt="fe_10" src="_images/gasd_estimation.png" style="height: 100px;" /></a></td>
<td><p class="first">Title: <strong>Globally Aligned Spatial Distribution (GASD) descriptors</strong></p>
<p>Author: <em>Joao Paulo Lima</em></p>
<p>Compatibility: &gt;= PCL 1.9</p>
<p class="last">This document describes the Globally Aligned Spatial Distribution (GASD) global descriptor to be used for efficient object recognition and pose estimation.</p>
</td>
</tr>
</tbody>
</table>
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="passthrough.php#passthrough"><span class="std std-ref">Filtering a PointCloud using a PassThrough filter</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="voxel_grid.php#voxelgrid"><span class="std std-ref">Downsampling a PointCloud using a VoxelGrid filter</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="statistical_outlier.php#statistical-outlier-removal"><span class="std std-ref">Removing outliers using a StatisticalOutlierRemoval filter</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="project_inliers.php#project-inliers"><span class="std std-ref">Projecting points using a parametric model</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="extract_indices.php#extract-indices"><span class="std std-ref">Extracting indices from a PointCloud</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="remove_outliers.php#remove-outliers"><span class="std std-ref">Removing outliers using a Conditional or RadiusOutlier removal</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="pcd_file_format.php#pcd-file-format"><span class="std std-ref">The PCD (Point Cloud Data) file format</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<li><p class="first"><a class="reference internal" href="reading_pcd.php#reading-pcd"><span class="std std-ref">Reading Point Cloud data from PCD files</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="8%" />
...
<li><p class="first"><a class="reference internal" href="writing_pcd.php#writing-pcd"><span class="std std-ref">Writing Point Cloud data to PCD files</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="8%" />
...
<li><p class="first"><a class="reference internal" href="concatenate_clouds.php#concatenate-clouds"><span class="std std-ref">Concatenate the points of two Point Clouds</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="3%" />
...
<li><p class="first"><a class="reference internal" href="openni_grabber.php#openni-grabber"><span class="std std-ref">The OpenNI Grabber Framework in PCL</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<li><p class="first"><a class="reference internal" href="hdl_grabber.php#hdl-grabber"><span class="std std-ref">The Velodyne High Definition LiDAR (HDL) Grabber</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<li><p class="first"><a class="reference internal" href="dinast_grabber.php#dinast-grabber"><span class="std std-ref">The PCL Dinast Grabber Framework</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<li><p class="first"><a class="reference internal" href="ensenso_cameras.php#ensenso-cameras"><span class="std std-ref">Grabbing point clouds from Ensenso cameras</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/ids.png"><img alt="i_o7" src="_images/ids.png" style="height: 165px;" /></a></td>
<td><p class="first">Title: <strong>Grabbing point clouds from Ensenso cameras</strong></p>
<p>Author: <em>Victor Lamoine</em></p>
<p>Compatibility: &gt;= PCL 1.8.0</p>
<p class="last">In this tutorial, we will learn how to acquire point cloud data from an IDS-Imaging Ensenso camera.</p>
</td>
</tr>
</tbody>
</table>
...
<li><p class="first"><a class="reference internal" href="davidsdk.php#david-sdk"><span class="std std-ref">Grabbing point clouds / meshes from davidSDK scanners</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/david.png"><img alt="i_o8" src="_images/david.png" style="height: 70px;" /></a></td>
<td><p class="first">Title: <strong>Grabbing point clouds / meshes from davidSDK scanners</strong></p>
<p>Author: <em>Victor Lamoine</em></p>
<p>Compatibility: &gt;= PCL 1.8.0</p>
<p class="last">In this tutorial, we will learn how to acquire point cloud or mesh data from a davidSDK scanner.</p>
</td>
</tr>
</tbody>
</table>
...
<li><p class="first"><a class="reference internal" href="depth_sense_grabber.php#depth-sense-grabber"><span class="std std-ref">Grabbing point clouds from DepthSense cameras</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/creative_camera.jpg"><img alt="i_o9" src="_images/creative_camera.jpg" style="height: 70px;" /></a></td>
<td><p class="first">Title: <strong>Grabbing point clouds from DepthSense cameras</strong></p>
<p>Author: <em>Sergey Alexandrov</em></p>
<p>Compatibility: &gt;= PCL 1.8.0</p>
<p class="last">In this tutorial we will learn how to setup and use DepthSense cameras within PCL on both Linux and Windows platforms.</p>
</td>
</tr>
</tbody>
</table>
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="narf_keypoint_extraction.php#narf-keypoint-extraction"><span class="std std-ref">How to extract NARF keypoint from a range image</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="kdtree_search.php#kdtree-search"><span class="std std-ref">How to use a KdTree to search</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="compression.php#octree-compression"><span class="std std-ref">Point Cloud Compression</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="octree.php#octree-search"><span class="std std-ref">Spatial Partitioning and Search Operations with Octrees</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="octree_change.php#octree-change-detection"><span class="std std-ref">Spatial change detection on unorganized point cloud data</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="range_image_creation.php#range-image-creation"><span class="std std-ref">How to create a range image from a point cloud</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="range_image_border_extraction.php#range-image-border-extraction"><span class="std std-ref">How to extract borders from range images</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="correspondence_grouping.php#correspondence-grouping"><span class="std std-ref">3D Object Recognition based on Correspondence Grouping</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="implicit_shape_model.php#implicit-shape-model"><span class="std std-ref">Implicit Shape Model</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="global_hypothesis_verification.php#global-hypothesis-verification"><span class="std std-ref">Tutorial: Hypothesis Verification for 3D Object Recognition</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/multiple.png"><img alt="rc_3" src="_images/multiple.png" style="height: 100px;" /></a></td>
<td><p class="first">Title: <strong>Hypothesis Verification for 3D Object Recognition</strong></p>
<p>Author: <em>Daniele De Gregorio, Federico Tombari</em></p>
<p>Compatibility: &gt; PCL 1.7</p>
<p class="last">This tutorial aims at explaining how to do 3D object recognition in clutter by verifying model hypotheses in cluttered and  heavily occluded 3D scenes.</p>
</td>
</tr>
</tbody>
</table>
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="registration_api.php#registration-api"><span class="std std-ref">The PCL Registration API</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="3%" />
...
<li><p class="first"><a class="reference internal" href="iterative_closest_point.php#iterative-closest-point"><span class="std std-ref">How to use iterative closest point</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="pairwise_incremental_registration.php#pairwise-incremental-registration"><span class="std std-ref">How to incrementally register pairs of clouds</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="interactive_icp.php#interactive-icp"><span class="std std-ref">Interactive Iterative Closest Point</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="8%" />
...
<li><p class="first"><a class="reference internal" href="normal_distributions_transform.php#normal-distributions-transform"><span class="std std-ref">How to use Normal Distributions Transform</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="in_hand_scanner.php#in-hand-scanner"><span class="std std-ref">In-hand scanner for small objects</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="alignment_prerejective.php#alignment-prerejective"><span class="std std-ref">Robust pose estimation of rigid objects</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="random_sample_consensus.php#random-sample-consensus"><span class="std std-ref">How to use Random Sample Consensus model</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="planar_segmentation.php#planar-segmentation"><span class="std std-ref">Plane model segmentation</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="cylinder_segmentation.php#cylinder-segmentation"><span class="std std-ref">Cylinder model segmentation</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="cluster_extraction.php#cluster-extraction"><span class="std std-ref">Euclidean Cluster Extraction</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<p>Compatibility: &gt; PCL 1.3</p>
<p class="last">In this tutorial we will learn how to extract Euclidean clusters with the <code class="docutils literal notranslate"><span class="pre">pcl::EuclideanClusterExtraction</span></code> class.</p>
</td>
</tr>
</tbody>
</table>
...
<li><p class="first"><a class="reference internal" href="region_growing_segmentation.php#region-growing-segmentation"><span class="std std-ref">Region growing segmentation</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<li><p class="first"><a class="reference internal" href="region_growing_rgb_segmentation.php#region-growing-rgb-segmentation"><span class="std std-ref">Color-based region growing segmentation</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="min_cut_segmentation.php#min-cut-segmentation"><span class="std std-ref">Min-Cut Based Segmentation</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<li><p class="first"><a class="reference internal" href="conditional_euclidean_clustering.php#conditional-euclidean-clustering"><span class="std std-ref">Conditional Euclidean Clustering</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="don_segmentation.php#don-segmentation"><span class="std std-ref">Difference of Normals Based Segmentation</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="supervoxel_clustering.php#supervoxel-clustering"><span class="std std-ref">Clustering of Pointclouds into Supervoxels - Theoretical primer</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<li><p class="first"><a class="reference internal" href="progressive_morphological_filtering.php#progressive-morphological-filtering"><span class="std std-ref">Identifying ground returns using ProgressiveMorphologicalFilter segmentation</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<li><p class="first"><a class="reference internal" href="model_outlier_removal.php#model-outlier-removal"><span class="std std-ref">Filtering a PointCloud using ModelOutlierRemoval</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="8%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/pcl_logo.png"><img alt="se_11" src="_images/pcl_logo.png" style="height: 75px;" /></a></td>
<td><p class="first">Title: <strong>Model outlier removal</strong></p>
<p>Author: <em>Timo Häckel</em></p>
<p>Compatibility: &gt;= PCL 1.7.2</p>
<p class="last">This tutorial describes how to extract points from a point cloud using SAC models</p>
</td>
</tr>
</tbody>
</table>
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="resampling.php#moving-least-squares"><span class="std std-ref">Smoothing and normal estimation based on polynomial reconstruction</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="hull_2d.php#hull-2d"><span class="std std-ref">Construct a concave or convex hull polygon for a plane model</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="greedy_projection.php#greedy-triangulation"><span class="std std-ref">Fast triangulation of unordered point clouds</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="3%" />
...
<li><p class="first"><a class="reference internal" href="bspline_fitting.php#bspline-fitting"><span class="std std-ref">Fitting trimmed B-splines to unordered point clouds</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="cloud_viewer.php#cloud-viewer"><span class="std std-ref">The CloudViewer</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="8%" />
...
<li><p class="first"><a class="reference internal" href="range_image_visualization.php#range-image-visualization"><span class="std std-ref">How to visualize a range image</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<li><p class="first"><a class="reference internal" href="pcl_visualizer.php#pcl-visualizer"><span class="std std-ref">PCLVisualizer</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="5%" />
...
<li><p class="first"><a class="reference internal" href="pcl_plotter.php#pcl-plotter"><span class="std std-ref">PCLPlotter</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="walkthrough.php#visualization"><span class="std std-ref">Visualization</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/visualization_small.png"><img alt="vi_5" src="_images/visualization_small.png" style="height: 120px;" /></a></td>
<td><p class="first">Title: <strong>PCL Visualization overview</strong></p>
<p>Author: <em>Radu B. Rusu</em></p>
<p>Compatibility: &gt;= PCL 1.0</p>
<p class="last">This tutorial will give an overview on the usage of the PCL visualization tools.</p>
</td>
</tr>
</tbody>
</table>
...
<li><p class="first"><a class="reference internal" href="qt_visualizer.php#qt-visualizer"><span class="std std-ref">Create a PCL visualizer in Qt with cmake</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/qt.png"><img alt="vi_6" src="_images/qt.png" style="height: 128px;" /></a></td>
...
<li><p class="first"><a class="reference internal" href="qt_colorize_cloud.php#qt-colorize-cloud"><span class="std std-ref">Create a PCL visualizer in Qt to colorize clouds</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="7%" />
...
<tbody valign="top">
<tr class="row-odd"><td><a class="reference internal" href="_images/qt.png"><img alt="vi_7" src="_images/qt.png" style="height: 128px;" /></a></td>
<td><p class="first">Title: <strong>Create a PCL visualizer in Qt to colorize clouds</strong></p>
...
<blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="template_alignment.php#template-alignment"><span class="std std-ref">Aligning object templates to a point cloud</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="3%" />
...
<li><p class="first"><a class="reference internal" href="vfh_recognition.php#vfh-recognition"><span class="std std-ref">Cluster Recognition and 6DOF Pose Estimation using VFH descriptors</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="mobile_streaming.php#mobile-streaming"><span class="std std-ref">Point Cloud Streaming to Mobile Devices with Real-time Visualization</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="4%" />
...
<li><p class="first"><a class="reference internal" href="ground_based_rgbd_people_detection.php#ground-based-rgbd-people-detection"><span class="std std-ref">Detecting people on a ground plane with RGB-D data</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="6%" />
...
<div><blockquote>
<div><ul>
<li><p class="first"><a class="reference internal" href="gpu_install.php#gpu-install"><span class="std std-ref">Configuring your PC to use your Nvidia GPU with PCL</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="8%" />
...
<li><p class="first"><a class="reference internal" href="using_kinfu_large_scale.php#using-kinfu-large-scale"><span class="std std-ref">Using Kinfu Large Scale to generate a textured mesh</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="3%" />
...
<li><p class="first"><a class="reference internal" href="gpu_people.php#gpu-people"><span class="std std-ref">Detecting people and their poses using PointCloud Library</span></a></p>
<blockquote>
<div><table border="1" class="docutils">
<colgroup>
<col width="9%" />
