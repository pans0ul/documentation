...
<blockquote>
<div><ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">Where</span> <span class="pre">is</span> <span class="pre">the</span> <span class="pre">source</span> <span class="pre">code</span></code> : this is the folder containing the CMakeLists.txt file and the sources.</li>
<li><code class="docutils literal notranslate"><span class="pre">Where</span> <span class="pre">to</span> <span class="pre">build</span> <span class="pre">the</span> <span class="pre">binaries</span></code> : this is where the Visual Studio project files will be generated</li>
</ul>
</div></blockquote>
